...
def init_app(app: Flask):
    ...
    api.add_resource(AllDoctors, "/doctors", endpoint="/doctors")
    ...
    api.add_resource(Episode, "/episode/<int:episode_id>",
                     endpoint="/episode/<int:episode_id>",
                     methods=["GET", "DELETE", "PATCH"])
    api.add_resource(DoctorEpisodes, "/episodes/doctor/<int:doctor_id>",
                     endpoint="/episodes/doctor/<int:doctor_id>",
                     methods=["GET"])
